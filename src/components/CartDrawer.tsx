            ...
            <>
                  ...
                  {items.map((item) => (
                    <div key={item.variantId} className="flex gap-4 p-3 rounded-lg bg-muted/30">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="font-semibold text-sm text-primary">CHF {parseFloat(item.price.amount).toFixed(2)}</p>
                      </div>
              ...
              <div className="flex-shrink-0 space-y-4 pt-4 border-t bg-background">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-xl font-bold text-primary">CHF {totalPrice.toFixed(2)}</span>
                </div>
                <Button onClick={handleCheckout} className="w-full bg-primary hover:bg-olive-dark text-primary-foreground" size="lg" disabled={items.length === 0 || isLoading || isSyncing}>
